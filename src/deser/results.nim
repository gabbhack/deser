...
func `==`*[T0: not void, E0, T1: not void, E1](lhs: Result[T0, E0], rhs: Result[
    T1, E1]): bool {.inline.} =
  if lhs.o != rhs.o:
    false
...
template unsafeError*[T, E](self: Result[T, E]): E =
  assert not self.o
  self.e
...
when isMainModule and appType != "lib":
  ...
  doAssert (rErr.mapErr(func(x: string): string = x & "no!").error == (
      rErr.error & "no!"))
